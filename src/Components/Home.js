...
const Home = () => {
  return (
    <>
    {/* <div className='text-center nav-bg'>
        Navbar
    </div> */}
    <div className="section1">
       ...
       <HiOutlineBookOpen className='section1__3Book '/>
        ...
        <div className="right">
            <img className='section1__img' src={require('../Senchola images1/3/guy-lesson 2.png')} alt='A man' width={'25%'} height={'73%'}/> 
    ...
    <div className="section4 container">
      ...
      <div className="lightorange__bubble"></div>
        <img src={require('../Senchola images1/1/Rectangle 4584.png')} className='section4__img' />
        {/* <div className="glass">
          <div className="glass__left">
          <RiPagesFill className='glass_icon'/>
          <MdOutlineDeveloperMode className='glass_icon'/>
          <HiSpeakerphone className='glass_icon'/>
          </div>
          <div className="glass__right">
          <p className='glass__bold'>5 Courses</p>
          <p className='glass__light'>UI/UX Design</p>
          </div>
          
          
          <div className="glass__right">
          <p className='glass__bold'>10 Courses</p>
          <p className='glass__light'>Development</p>
          </div>
          
          
          <div className="glass__right">
          <p className='glass__bold'>4 Courses</p>
          <p className='glass__light'>Marketing</p>
          </div>
        </div> */}
    ...
    <div className="section5">
      ...
      <div className="grid_photos container my-5">
        ...
        <img src={require('../Senchola images1/3/Rectangle 18.png')} alt='photo' width={'90%'} className='grid_photos_1'/>
        <div className="span2">
        <img src={require('../Senchola images1/3/Rectangle 19.png')} alt='photo' width={'90%'} className='grid_photos_2'/>
        <img src={require('../Senchola images1/3/Rectangle 20.png')} alt='photo' width={'90%'} className='grid_photos_3'/>
        </div>
        <img src={require('../Senchola images1/3/gridPhotos4.png')} alt='photo' width={'90%'} className='grid_photos_4'/>
    ...
    <div className="section6 mb-5">
      ...
      <div className="user">
        <img src={require('../Senchola images1/3/gridPhotos4.png')} alt='user-photos' className='pro_pic' />
